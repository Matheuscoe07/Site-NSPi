...
// ADIÇÃO: validações de e-mail e senha
...
export default function Registrar() {
  ...
  async function handleRegister(e?: React.FormEvent) {
    ...
    // ADIÇÃO: normaliza e valida credenciais
    const emailNormalizado = email.trim().toLowerCase()
    const valida = validateCredentials(emailNormalizado, senha)
    if (!valida.valid) {
      alert('Corrija os seguintes pontos:\n- ' + valida.problems.join('\n- '))
      return
    }
        ...
        .insert([
          {
            nome,
            sobrenome,
            email: emailNormalizado, // ADIÇÃO: usa e-mail normalizado
            senha_hash,
            data_cadastro,
            tipo_usuario: 'user',
          },
